...
class AliOssClient:
    def __init__(
        ...
        sign="9AD4AA35AAFEE6BB1E847A76848D58DF",
        v=2,
    ):
        self.bucket = bucket
        ...
        SecurityToken, AccessKeyId, AccessKeySecret, client = self.initClient()
    ...
    def initClient(self):
        ...
        client = oss2.Bucket(auth, "https://oss-cn-beijing.aliyuncs.com", self.bucket)
        return SecurityToken, AccessKeyId, AccessKeySecret, client
